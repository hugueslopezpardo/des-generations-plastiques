...
Route::post('/reports/initial/{token}', [ReportInitialController::class, 'finish'])
    ->middleware(['auth', 'verified', 'setup'])
    ->name('reports.initial.finish');

Route::post('/reports/intermediate/{token}', [ReportIntermediateController::class, 'finish'])
    ->middleware(['auth', 'verified', 'setup'])
    ->name('reports.intermediate.finish');

Route::post('/reports/final/{token}', [ReportFinalController::class, 'finish'])
    ->middleware(['auth', 'verified', 'setup'])
