                            ...
                            <article className={"mx-auto min-h-screen flex justify-center items-center flex-col container px-12 md:px-0 py-24 space-y-12"}>
                                <div className={'space-y-4 text-center'}>
                                    ...
                                    <p className={"text-justify font-bold text-md"}>
                                        Une expérience de 4 mois qui a pour objectifs de tester la dégradabilité de bioplastiques dans des environnements variés.
                                    </p>
                                </div>
                            </article>
                        </section>
                                    ...
                                    <div className={'space-y-8 flex justify-center flex-col'}>
                                        ...
                                        <div className={'space-y-4'}>
                                            ...
                                            <ul className={'list-disc list-inside'}>
                                                <li>Un cadre a exposer ou enfouir</li>
                                                <li>Une notice d’utilisation</li>
                                                <li>Quatre "clous" en PHA (pour exposition sur le sol, les clous à partir de morceaux de fil de PHA)</li>
                                            ...
                                            <Card>
                                                ...
                                                <CardContent>
                                                    <CardDescription className={'text-primary font-bold'}>
                                                        Le petit plus de la recherche : envoyez votre échantillon au Döme. Les scientifiques de l'ABTE pourront l'analyser afin d'affiner les conclusions de la recherche.
                                                    </CardDescription>
                                                </CardContent>
                                                <CardFooter>
                                                    <a href={'https://tally.so/r/3lypo6'}>
                                                        <Button>
