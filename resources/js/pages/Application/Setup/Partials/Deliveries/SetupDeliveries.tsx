 ...
 */
const SetupDeliveries = ({regions}: SetupDeliveriesProps) => {
    ...
    return (
        <>
            <Card className={'w-96 md:w-3/4 shadow-2xl'}>
                ...
                <CardContent>
                    <Grid columns={{
                        ...
                        {/* La Poste */}
                        <Card className={`duration-300 transform hover:scale-105 hover:shadow-2xl hover:cursor-pointer hover:border-2 hover:border-yellow-500 group
                        ${deliveryMethod === 'laposte' ? 'border-2 border-yellow-500' : ''}`}
                            ...
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Si vous souhaitez recevoir votre kit de démarrage à votre domicile, choisissez cette
                                    option pour une livraison par La Poste.
                                </CardDescription>
                            </CardHeader>
                        </Card>
                        ...
                        <Card className={`duration-300 transform hover:scale-105 hover:shadow-2xl hover:cursor-pointer hover:border-2 hover:border-yellow-500 group
                            ...
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Vous êtes de Caen ou des environs, choisissez cette option pour venir chercher votre
                                    kit de
                                    démarrage au Dôme de Caen.
                                </CardDescription>
                            </CardHeader>
                        </Card>
            ...
            {deliveryMethod === 'laposte' && (
                <SetupDeliveryPoste setDeliveryMethod={setDeliveryMethod}/>)}
