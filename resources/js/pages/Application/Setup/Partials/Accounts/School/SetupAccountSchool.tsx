...
const SetupAccountSchool = ({regions, levels}: SetupSchoolProps) => {
                ...
                <form onSubmit={submit}>
                    <Flex direction={'column'} gap={'4'}>
                        ...
                        {data.school_region === 'Normandie' && (<Flex direction={'column'} gap={'2'}>
                                ...
                                <Select onValueChange={(value) => setData('school_is_ngp', value === 'true')}>
                                    <SelectTrigger className={`${errors.school_is_ngp ? 'border-red-500' : ''}`}>
                                        <SelectValue placeholder={'Votre réponse'}/>
                                    </SelectTrigger>
                                    <SelectContent>
                                        <SelectGroup>
                                            <SelectLabel>
                                                Votre établissement scolaire a-t-il été sélectionné pour le
                                                programme {" "} "Nouvelles Générations Plastiques" ?
                                            </SelectLabel>
                        ...
                        {data.school_region === 'Normandie' && data.school_is_ngp && (
                            <Flex direction={'column'} gap={'2'}>
                                ...
                                >
                                    <SelectTrigger
                                        className={`${errors.school_is_ngp_autonomous ? 'border-red-500' : ''}`}>
                                        <SelectValue placeholder={'Votre réponse'}/>
                                    </SelectTrigger>
                                    <SelectContent>
                                        <SelectGroup>
                                            <SelectLabel>Votre réponse</SelectLabel>
                                            <SelectItem value={'true'}>Oui</SelectItem>
                                            <SelectItem value={'false'}>Non</SelectItem>
                                        </SelectGroup>
                                    </SelectContent>
