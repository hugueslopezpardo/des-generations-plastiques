              ...
              return (
                  <ReactFullpage.Wrapper>
                                    ...
                                    <article className={'min-h-screen container mx-auto'}>
                                      ...
                                      technique et industrielle de Caen Normandie. Il s’inscrit au
                                      sein de PROSPERITY, un programme plus vaste de recherche
                                      mixte sur les matériaux plastiques et composites 100%
                                      biosourcés et 100% biodégradables.
                                                </p>
                      ...
                      <section className={"section bg-[#FFFFFF]"}>
                          <article className={"mx-auto min-h-screen flex justify-center items-center flex-col container py-24 space-y-24"}>
                              <div className={"grid grid-cols-1 md:grid-cols-2 gap-16 p-4 md:p-0"}>
                                  <div className={'flex justify-center items-center'}>
                                      <div className={'w-[80%] aspect-square rounded-lg bg-gray-200 mx-auto'} style={{backgroundImage: 'url(assets/images/depestel.jpg)', backgroundSize: 'cover', backgroundPosition: 'top'}}/>
                                  </div>
                                  <div className={'space-y-4'}>
                                      <h1 className={"text-5xl text-left font-saps-regular"}>
                                          Le groupe Depestele
                                      ...
                                      <p className={'text-md text-justify'}>
                                          L’objectif de <span className={'font-bold'}>PROSPERITY, financé par l&#39;appel à projets &#34;I-Démo&#34; du plan France 2030, </span> est
                                          d’industrialiser des renforts pré-imprégnés issus à 100% de
                                          ressources renouvelables <span className={'font-bold'}>(fibres de lin et polymères biosourcés et biodégradables, nottament les PHAs)</span>,
                                          en proposant les garanties de qualité, de reproductibilité, de
                                          performances et une analyse de cycle de vie maitrisée.
                                      </p>
