                            ...
                            <CardDescription>
                                <Flex direction={'column'} gap={'2'}>
                                    <Card className={'border-2 border-yellow-500'}>
                                        ...
                                        <CardFooter>
                                            <CardDescription>
                                                <Button onClick={() => handleLinkCopy('https://google.com')} disabled={true}> Accéder au questionnaire{' '} <ArrowRight size={16}/></Button>
                                            </CardDescription>
                                        </CardFooter>
                                    </Card>
                                    <Card className={'border-2 border-red-500'}>
                                        <CardHeader>
                                            ...
                                            <CardDescription>
                                                Voilà maintenant trois semaines que vous avez débuté l’aventure Des
                                                générations plastiques.
                                                Nous espérons que tout se passe bien pour vous, que vous découvrez des
                                                choses et prenez plaisir à réfléchir sur les plastiques. Que pensez-vous
                                                de ce début d’aventure ? Comment avez-vous appréhendé et géré cette
