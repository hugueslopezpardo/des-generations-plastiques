                    ...
                    <form onSubmit={submit}>
                        <Flex direction={'column'} gap={'4'}>
                            ...
                            <Flex direction={'column'} gap={'2'}>
                                ...
                                <Input type="text" placeholder="Prénom de l'élève" id="first_name" className={`${errors.first_name ? 'border-red-500' : ''}`} onChange={(e) => setData('first_name', e.target.value)}/>
                                <Text className={'text-red-500 text-sm'}>{errors.first_name}</Text>
                            </Flex>

                            <Flex direction={'column'} gap={'2'}>
                                <Label htmlFor="last_name">Nom</Label>
                                <Input type="text" placeholder="Nom de l'élève" id="last_name" className={`${errors.last_name ? 'border-red-500' : ''}`} onChange={(e) => setData('last_name', e.target.value)}/>
            ...
            <Card>
                ...
                <CardContent>
                    <Table>
                        ...
                        <TableFooter>
                            <TableRow>
                                <TableCell colSpan={8}>Nombre total d'élèves: {students.length}</TableCell>
                            </TableRow>
                        </TableFooter>
                    </Table>
