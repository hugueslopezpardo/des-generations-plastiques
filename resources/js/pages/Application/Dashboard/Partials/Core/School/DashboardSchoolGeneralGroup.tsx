...
const DashboardSchoolGeneralGroup = ({teacher}: DashboardSchoolGeneralGroupProps) => {
    ...
    return (<Card>
        <CardHeader>
            ...
            <CardDescription>
                Vous souhaitez répondre au questionnaire en tant que groupe ? C'est par ici ! Si jamais vous
                souhaitez répondre en tant qu'individu, vous pouvez le faire en ajoutant vos élèves un par un
                dans la section "Mes élèves", ils auront ainsi accès à leur propre questionnaire dans la section
                "Individuel".
            </CardDescription>
        </CardHeader>
        <CardContent>
                        ...
                        <CardDescription>
                            <Flex direction={'column'} gap={'2'}>
                                <Card className={`${is_first_report_finished ? 'border-2 border-green-500' : 'border-2 border-yellow-500'}`}>
                                                ...
                                                <div className={'h-full col-span-1 flex justify-center'}>
                                                    <div
                                                        ...
                                                        <QRCode
                                                            ...
                                                            value={`https://des-generations-plastiques-app.dhrcy9.easypanel.host/reports/final/${token}`}
                                                            viewBox={`0 0 256 256`}
                                                        />
                                                    </div>
                                                </div>
                                    ...
                                    <CardFooter>
                                        <CardDescription className={'space-x-2'}>
                                            <a href={`https://des-generations-plastiques-app.dhrcy9.easypanel.host/reports/initial/${token}`}>
                                                <Button>
                                ...
                                <Card className={`${is_second_report_finished ? 'border-2 border-green-500' : 'border-2 border-yellow-500'}`}>
                                                ...
                                                <div className={'h-full col-span-1 flex justify-center'}>
                                                    <div
                                                        ...
                                                        <QRCode
                                                            ...
                                                            value={`https://des-generations-plastiques-app.dhrcy9.easypanel.host/reports/intermediate/${token}`}
                                                            viewBox={`0 0 256 256`}
                                                        />
                                                    </div>
                                                </div>
                                    ...
                                    <CardFooter>
                                        <CardDescription>
                                            <a href={`https://des-generations-plastiques-app.dhrcy9.easypanel.host/reports/intermediate/${token}`}>
                                                <Button>
                                                    Accéder au questionnaire {' '} <ArrowRight size={16}/>
                                                </Button>
                                            </a>
                                ...
                                <Card className={`${is_third_report_finished ? 'border-2 border-green-500' : 'border-2 border-yellow-500'}`}>
                                    ...
                                    <CardFooter>
                                        <CardDescription>
                                            <a href={`https://des-generations-plastiques-app.dhrcy9.easypanel.host/reports/final/${token}`}>
                                                <Button>
                                                    Accéder au questionnaire {' '} <ArrowRight size={16}/>
                                                </Button>
                                            </a>
