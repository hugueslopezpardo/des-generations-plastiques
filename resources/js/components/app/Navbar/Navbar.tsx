                    ...
                    >
                        ...
                        <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                            <div className="flow-root">
                                <a href={'https://tally.so/r/3lypo6'} className="-m-2 block p-2 font-medium text-gray-900">
                                    Pré-inscription
                                </a>
                            </div>
                        </div>
                                    ...
                                    <div className="hidden h-full lg:flex">
                                        ...
                                        <PopoverGroup className="inset-x-0 bottom-0 px-4">
                                            <div className="flex h-full justify-center space-x-16">
                                                ...
                                                <Link href={'/program'} onClick={() => setCurrentPath('/program')}
                                                ...
                                                <Link href={'/participate'} onClick={() => setCurrentPath('/participate')}
